 ...
 */
export function interpretLayoutType(node) {
 ...
 */
export function interpretDirection(layoutMode) {
  switch (layoutMode) {
    case "VERTICAL":
      return "column";
    case "HORIZONTAL":
 ...
 */
export function interpretAlignItems(counterAxisAlignItems) {
 ...
 */
export function interpretJustifyContent(primaryAxisAlignItems) {
 ...
 */
export function interpretPadding(padding) {
  return {
    top: padding?.top || 0,
 ...
 */
export function interpretGap(itemSpacing) {
